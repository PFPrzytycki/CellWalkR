...
scATAC-seq data with labels and other epigenetic data (see [paper](https://doi.org/10.1186/s13059-021-02279-1) for details). 
This vignette shows
...
Once we have created a cellWalk object, we can use it for downstream analysis. At
this stage a visualization can be launched for interactive downstream analysis. See
the [interacting with your cellWalk object vignette](Interacting_Vignette.md) for details.
